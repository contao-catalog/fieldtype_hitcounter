...
// Palettes
$GLOBALS['TL_DCA']['tl_catalog_fields']['palettes']['hitsfield'] = 'name,description,colName,type,hitsfield';

// register to catalog module that we provide the ajaxratingfield as field type.
$GLOBALS['TL_DCA']['tl_catalog_fields']['fields']['type']['options'][] = 'hitsfield';
